...
namespace ContosoWebApi.Migrations
{
    ...
    [Migration("20200520143259_AddIsDeleted")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContosoWebApi.Model.Course", b =>
                {
            ...
            modelBuilder.Entity("ContosoWebApi.Model.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContosoWebApi.Model.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("ContosoWebApi.Model.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("ContosoWebApi.Model.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContosoWebApi.Model.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("ContosoWebApi.Model.Course", b =>
                {
                    b.HasOne("ContosoWebApi.Model.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("ContosoWebApi.Model.CourseInstructor", b =>
                {
                    b.HasOne("ContosoWebApi.Model.Course", "Course")
                    ...
                    b.HasOne("ContosoWebApi.Model.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("ContosoWebApi.Model.Enrollment", b =>
                {
                    ...
                    b.HasOne("ContosoWebApi.Model.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("ContosoWebApi.Model.OfficeAssignment", b =>
                {
                    b.HasOne("ContosoWebApi.Model.Person", "Instructor")
                        ...
                        .HasForeignKey("ContosoWebApi.Model.OfficeAssignment", "InstructorId")
